                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Sign in to continue to Register.</p>
                                        </div>
                                        ...
                                        <form class="mt-4 pt-2" action="{{route('client.register.submit')}}" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    ...
                                                    <button class="btn btn-light shadow-none ms-0" name="password" type="button" id="password"><i class="mdi mdi-eye-outline"></i></button>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <img src="{{asset('backend/assets/images/users/avatar-3.jpg')}}" class="avatar-md img-fluid rounded-circle" alt="...">
