...
<div class="row">
    <div class="col-lg-6">
        <div>
            ...
            <img id="showImage" src="{{ (!empty($profileData->cover_photo)) ? url('upload/client_images/'.$profileData->cover_photo) : url('upload/1.jpg') }}" alt="" class="p-1 bg-primary" width="210" height="100">
    ...
    <div class="col-lg-6">
        <div class="mt-3 mt-lg-0">
            ...
            <div class="mb-3">
                ...
                <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/client_images/'.$profileData->photo) : url('upload/1.jpg') }}" alt="" class="rounded-circle p-1 bg-primary" width="110">
            </div>
            <div class="mt-4">
