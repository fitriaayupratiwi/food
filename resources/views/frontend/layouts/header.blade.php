    ...
    <div class="container">
     ...
     @endphp
         <li class="nav-item dropdown">
            ...
            <img alt="Generic placeholder image" src="{{ (!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/3.jpg') }}" class="nav-osahan-pic rounded-pill"> My Account
            </a>
