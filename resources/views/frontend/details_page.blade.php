...
@section('dashboard')
    ...
    @php
        $products = App\Models\Product::where('client_id', $client->id)
            ->limit(3)
            ->get();
        $menuNames = $products->map(fn($product) => $product->menu?->menu_name)->filter()->toArray();
                                            ...
                                            <div
                                                ...
                                                <div class="p-3 position-relative">
                                                    <div class="list-card-body">
                                                        ...
                                                        <p class="text-gray mb-2">{{ $bestseller['city']['city_name'] }}
                                                        </p>
                        ...
                        @if (Session::has('coupon'))
                            <div class="mb-2 bg-white rounded p-2 clearfix">
                                ...
                                <p class="mb-1">Coupon Name <span
                                        ...
                                        {{ session()->get('coupon')['discount'] }} %) </span><a type="submit"
                                        onclick="couponRemove()"><i class="icofont-ui-delete float-right"
                                            style="color: red;"></i></a>
                                </p>
